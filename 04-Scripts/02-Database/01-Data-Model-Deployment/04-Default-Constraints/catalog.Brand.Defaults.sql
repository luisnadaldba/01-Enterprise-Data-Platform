    ...
    DECLARE @BRD_default_expected_name          sysname;
    DECLARE @BRD_default_actual_name            sysname;
    DECLARE @BRD_default_actual_definition      nvarchar(4000);
    DECLARE @BRD_default_normalized_definition  nvarchar(4000);
    DECLARE @BRD_default_parent_object          nvarchar(517);


    /*==============================================================================
        DEFAULT CONSTRAINT: DF_BRD_is_active
    ==============================================================================*/

    SET @BRD_default_expected_name = N'DF_BRD_is_active';

    SET @BRD_default_actual_name = NULL;
    SET @BRD_default_actual_definition = NULL;
    SET @BRD_default_normalized_definition = NULL;
    SET @BRD_default_parent_object = NULL;


    /*----------------------------------------------------------------------
        VALIDATE DEFAULT CURRENTLY ASSOCIATED WITH BRD_is_active
    ----------------------------------------------------------------------*/
    ...
    WHERE dc.parent_object_id = OBJECT_ID(N'catalog.Brand')
    AND c.name = N'BRD_is_active';


    /*----------------------------------------------------------------------
        NO DEFAULT CURRENTLY EXISTS ON BRD_is_active
    ----------------------------------------------------------------------*/
    ...
    BEGIN
        ...
        SET @BRD_default_normalized_definition =
            LOWER
            (
                REPLACE
                (
    ...
    /*==============================================================================
        DEFAULT CONSTRAINT: DF_BRD_created_at
    ==============================================================================*/

    SET @BRD_default_expected_name = N'DF_BRD_created_at';
    ...
    /*==============================================================================
        DEFAULT CONSTRAINT: DF_BRD_updated_at
    ==============================================================================*/

    SET @BRD_default_expected_name = N'DF_BRD_updated_at';
