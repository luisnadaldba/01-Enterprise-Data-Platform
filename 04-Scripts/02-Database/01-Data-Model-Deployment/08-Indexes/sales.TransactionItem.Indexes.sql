    ...
    BEGIN
        ...
        DECLARE TRNIT_partition_divergence_cursor CURSOR LOCAL FAST_FORWARD
        FOR
            SELECT
                index_name,
                data_space_name
        ...
        OPEN TRNIT_partition_divergence_cursor;

        FETCH NEXT FROM TRNIT_partition_divergence_cursor
        INTO
        ...
        CLOSE TRNIT_partition_divergence_cursor;
        DEALLOCATE TRNIT_partition_divergence_cursor;
    ...
    */
    ...
    BEGIN
        ...
        BEGIN
            ...
            ;THROW 50073,
                N'Transaction item history index is not aligned with PS_SALES_MONTHLY.',
                1;
    ...
    */
    ...
    BEGIN
        ...
        BEGIN
            ...
            ;THROW 50073,
                N'No structurally equivalent transaction item history index is aligned with PS_SALES_MONTHLY.',
                1;
