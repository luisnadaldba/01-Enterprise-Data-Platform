    ...
    (
        ...
        WHERE parent_column.object_id = OBJECT_ID(N'catalog.ProductVariantAttributeValue')
        AND parent_column.name = N'PRDAV_PRDVA_id'
    ...
    SELECT
        @PRDAV_FK_PRDVA_actual_name = fk.name,
        ...
        @PRDAV_FK_PRDVA_actual_delete_action = fk.delete_referential_action_desc,
        @PRDAV_FK_PRDVA_actual_update_action = fk.update_referential_action_desc,
        @PRDAV_FK_PRDVA_actual_is_disabled = fk.is_disabled,
        @PRDAV_FK_PRDVA_actual_is_not_trusted = fk.is_not_trusted,
    ...
    WHERE fk.parent_object_id = OBJECT_ID(N'catalog.ProductVariantAttributeValue')
    AND fk.name = @PRDAV_FK_PRDVA_expected_name;
    ...
    BEGIN
        ...
        IF @PRDAV_FK_PRDVA_actual_parent_table = N'[catalog].[ProductVariantAttributeValue]'
        AND @PRDAV_FK_PRDVA_actual_parent_columns = N'PRDAV_PRDVA_id'
        AND @PRDAV_FK_PRDVA_actual_referenced_table =
            N'[catalog].[ProductVariant]'
        AND @PRDAV_FK_PRDVA_actual_referenced_columns = N'PRDVA_id'
        AND @PRDAV_FK_PRDVA_actual_delete_action = N'NO_ACTION'
        AND @PRDAV_FK_PRDVA_actual_update_action = N'NO_ACTION'
        ...
        BEGIN
            ...
            PRINT N'            Actual Table                    : '
                + COALESCE(@PRDAV_FK_PRDVA_actual_parent_table, N'<NULL>');
            PRINT N'            Expected Column                 : PRDAV_PRDVA_id';
            PRINT N'            Actual Column                   : '
                + COALESCE(REPLACE(@PRDAV_FK_PRDVA_actual_parent_columns, N'|', N', '), N'<NULL>');
            PRINT N'            Expected Reference              : catalog.ProductVariant.PRDVA_id';
            PRINT N'            Actual Reference Table         : '
                + COALESCE(@PRDAV_FK_PRDVA_actual_referenced_table, N'<NULL>');
            PRINT N'            Actual Reference Column        : '
                + COALESCE(REPLACE(@PRDAV_FK_PRDVA_actual_referenced_columns, N'|', N', '), N'<NULL>');
            PRINT N'            Expected ON DELETE              : NO ACTION';
            PRINT N'            Actual ON DELETE                : '
                + COALESCE(@PRDAV_FK_PRDVA_actual_delete_action, N'<NULL>');
            PRINT N'            Expected ON UPDATE              : NO ACTION';
            PRINT N'            Actual ON UPDATE                : '
                + COALESCE(@PRDAV_FK_PRDVA_actual_update_action, N'<NULL>');
            PRINT N'            Expected Disabled               : 0';
            PRINT N'            Actual Disabled                 : '
                + COALESCE(CONVERT(nvarchar(1), @PRDAV_FK_PRDVA_actual_is_disabled), N'<NULL>');
            PRINT N'            Expected Not Trusted            : 0';
            PRINT N'            Actual Not Trusted              : '
                + COALESCE(CONVERT(nvarchar(1), @PRDAV_FK_PRDVA_actual_is_not_trusted), N'<NULL>');
    ...
    BEGIN
        ...
        SELECT TOP (1)
            @PRDAV_FK_PRDVA_equivalent_name = fk.name,
            @PRDAV_FK_PRDVA_equivalent_delete_action = fk.delete_referential_action_desc,
            @PRDAV_FK_PRDVA_equivalent_update_action = fk.update_referential_action_desc,
            @PRDAV_FK_PRDVA_equivalent_is_disabled = fk.is_disabled,
            @PRDAV_FK_PRDVA_equivalent_is_not_trusted = fk.is_not_trusted
        ...
        BEGIN
            ...
            PRINT N'            Actual Name                    : ' + @PRDAV_FK_PRDVA_equivalent_name;
            PRINT N'            Column                         : PRDAV_PRDVA_id';
            PRINT N'            References                     : catalog.ProductVariant.PRDVA_id';
            PRINT N'            ON DELETE                      : '
                + COALESCE(@PRDAV_FK_PRDVA_equivalent_delete_action, N'<NULL>');
            PRINT N'            ON UPDATE                      : '
                + COALESCE(@PRDAV_FK_PRDVA_equivalent_update_action, N'<NULL>');
            PRINT N'            Disabled                       : '
                + COALESCE(CONVERT(nvarchar(1), @PRDAV_FK_PRDVA_equivalent_is_disabled), N'<NULL>');
            PRINT N'            Not Trusted                    : '
                + COALESCE(CONVERT(nvarchar(1), @PRDAV_FK_PRDVA_equivalent_is_not_trusted), N'<NULL>');
            PRINT N'            Existing constraint was preserved for review.';
            ...
            BEGIN
                ...
                SELECT
                    @PRDAV_FK_PRDVA_conflict_parent =
                        ...
                        + QUOTENAME(OBJECT_NAME(fk.parent_object_id))
                FROM sys.foreign_keys AS fk
                WHERE fk.object_id = OBJECT_ID(N'catalog.FK_PRDAV_PRDVA', N'F');


                PRINT N'        [!] Foreign key name conflict       : FK_PRDAV_PRDVA';
                PRINT N'            Expected Table                  : catalog.ProductVariantAttributeValue';
                PRINT N'            Existing Parent                 : '
                    + COALESCE(@PRDAV_FK_PRDVA_conflict_parent, N'<UNKNOWN>');
    ...
    (
        ...
        INNER JOIN sys.columns AS referenced_column
            ON referenced_column.object_id = OBJECT_ID(N'catalog.ProductAttributeValue')

        WHERE parent_column.object_id = OBJECT_ID(N'catalog.ProductVariantAttributeValue')
        AND parent_column.name = N'PRDAV_PATVL_id'
        AND referenced_column.name = N'PATVL_id'
        AND parent_column.system_type_id = referenced_column.system_type_id
        AND parent_column.max_length = referenced_column.max_length
        AND parent_column.precision = referenced_column.precision
        AND parent_column.scale = referenced_column.scale
    ...
    SELECT
        @PRDAV_FK_PATVL_actual_name = fk.name,
        ...
        @PRDAV_FK_PATVL_actual_delete_action = fk.delete_referential_action_desc,
        @PRDAV_FK_PATVL_actual_update_action = fk.update_referential_action_desc,
        @PRDAV_FK_PATVL_actual_is_disabled = fk.is_disabled,
        @PRDAV_FK_PATVL_actual_is_not_trusted = fk.is_not_trusted,
    ...
    WHERE fk.parent_object_id = OBJECT_ID(N'catalog.ProductVariantAttributeValue')
    AND fk.name = @PRDAV_FK_PATVL_expected_name;
    ...
    BEGIN
        ...
        IF @PRDAV_FK_PATVL_actual_parent_table = N'[catalog].[ProductVariantAttributeValue]'
        AND @PRDAV_FK_PATVL_actual_parent_columns = N'PRDAV_PATVL_id'
        AND @PRDAV_FK_PATVL_actual_referenced_table =
            N'[catalog].[ProductAttributeValue]'
        AND @PRDAV_FK_PATVL_actual_referenced_columns = N'PATVL_id'
        AND @PRDAV_FK_PATVL_actual_delete_action = N'NO_ACTION'
        AND @PRDAV_FK_PATVL_actual_update_action = N'NO_ACTION'
        ...
        BEGIN
            ...
            PRINT N'            Expected Table                  : catalog.ProductVariantAttributeValue';
            PRINT N'            Actual Table                    : '
                + COALESCE(@PRDAV_FK_PATVL_actual_parent_table, N'<NULL>');
            PRINT N'            Expected Column                 : PRDAV_PATVL_id';
            PRINT N'            Actual Column                   : '
                + COALESCE(REPLACE(@PRDAV_FK_PATVL_actual_parent_columns, N'|', N', '), N'<NULL>');
            PRINT N'            Expected Reference              : catalog.ProductAttributeValue.PATVL_id';
            PRINT N'            Actual Reference Table         : '
                + COALESCE(@PRDAV_FK_PATVL_actual_referenced_table, N'<NULL>');
            PRINT N'            Actual Reference Column        : '
                + COALESCE(REPLACE(@PRDAV_FK_PATVL_actual_referenced_columns, N'|', N', '), N'<NULL>');
            PRINT N'            Expected ON DELETE              : NO ACTION';
            PRINT N'            Actual ON DELETE                : '
                + COALESCE(@PRDAV_FK_PATVL_actual_delete_action, N'<NULL>');
            PRINT N'            Expected ON UPDATE              : NO ACTION';
            PRINT N'            Actual ON UPDATE                : '
                + COALESCE(@PRDAV_FK_PATVL_actual_update_action, N'<NULL>');
            PRINT N'            Expected Disabled               : 0';
            PRINT N'            Actual Disabled                 : '
                + COALESCE(CONVERT(nvarchar(1), @PRDAV_FK_PATVL_actual_is_disabled), N'<NULL>');
            PRINT N'            Expected Not Trusted            : 0';
            PRINT N'            Actual Not Trusted              : '
                + COALESCE(CONVERT(nvarchar(1), @PRDAV_FK_PATVL_actual_is_not_trusted), N'<NULL>');
            PRINT N'            Existing constraint was preserved for review.';
    ...
    BEGIN
        ...
        SELECT TOP (1)
            @PRDAV_FK_PATVL_equivalent_name = fk.name,
            @PRDAV_FK_PATVL_equivalent_delete_action = fk.delete_referential_action_desc,
            @PRDAV_FK_PATVL_equivalent_update_action = fk.update_referential_action_desc,
            @PRDAV_FK_PATVL_equivalent_is_disabled = fk.is_disabled,
            @PRDAV_FK_PATVL_equivalent_is_not_trusted = fk.is_not_trusted

        FROM sys.foreign_keys AS fk

        WHERE fk.parent_object_id = OBJECT_ID(N'catalog.ProductVariantAttributeValue')
        AND fk.referenced_object_id = OBJECT_ID(N'catalog.ProductAttributeValue')
        AND fk.name <> @PRDAV_FK_PATVL_expected_name
        AND fk.delete_referential_action = 0
        AND fk.update_referential_action = 0
        AND
        ...
        (
            ...
            WHERE fkc.constraint_object_id = fk.object_id
                AND fkc.constraint_column_id = 1
                AND pc.name = N'PRDAV_PATVL_id'
                AND rc.name = N'PATVL_id'
        )
        ...
        BEGIN
            ...
            PRINT N'            Actual Name                    : ' + @PRDAV_FK_PATVL_equivalent_name;
            PRINT N'            Column                         : PRDAV_PATVL_id';
            PRINT N'            References                     : catalog.ProductAttributeValue.PATVL_id';
            PRINT N'            ON DELETE                      : '
                + COALESCE(@PRDAV_FK_PATVL_equivalent_delete_action, N'<NULL>');
            PRINT N'            ON UPDATE                      : '
                + COALESCE(@PRDAV_FK_PATVL_equivalent_update_action, N'<NULL>');
            PRINT N'            Disabled                       : '
                + COALESCE(CONVERT(nvarchar(1), @PRDAV_FK_PATVL_equivalent_is_disabled), N'<NULL>');
            PRINT N'            Not Trusted                    : '
                + COALESCE(CONVERT(nvarchar(1), @PRDAV_FK_PATVL_equivalent_is_not_trusted), N'<NULL>');
            PRINT N'            Existing constraint was preserved for review.';
            ...
            BEGIN
                ...
                SELECT
                    @PRDAV_FK_PATVL_conflict_parent =
                        ...
                        + QUOTENAME(OBJECT_NAME(fk.parent_object_id))
                FROM sys.foreign_keys AS fk
                WHERE fk.object_id = OBJECT_ID(N'catalog.FK_PRDAV_PATVL', N'F');


                PRINT N'        [!] Foreign key name conflict       : FK_PRDAV_PATVL';
                PRINT N'            Expected Table                  : catalog.ProductVariantAttributeValue';
                PRINT N'            Existing Parent                 : '
                    + COALESCE(@PRDAV_FK_PATVL_conflict_parent, N'<UNKNOWN>');
                PRINT N'            Constraint was not created. Manual review is required.';
