    ...
    (
        ...
        WHERE ep.class = 1
        AND ep.major_id = OBJECT_ID(N'payment.PaymentRefundReason')
        AND ep.minor_id = 0
    ...
    BEGIN
        ...
        BEGIN
            ...
            PRINT N'            Actual                       : '
                + CASE
                    WHEN @PAYRR_existing_description IS NULL THEN N'<NULL>'
                    WHEN LEN(@PAYRR_existing_description) = 0 THEN N'<EMPTY>'
                    ELSE @PAYRR_existing_description
                END;
