    ...
    (
        ...
        WHERE ep.class = 1
        AND ep.major_id = OBJECT_ID(N'inventory.InventoryMovementNote')
        AND ep.minor_id = 0
    ...
    BEGIN
        ...
        IF @INVMN_existing_description = @INVMN_expected_description
        BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            PRINT N'            Actual                       : '
                + CASE
                    WHEN @INVMN_existing_description IS NULL THEN N'<NULL>'
                    WHEN LEN(@INVMN_existing_description) = 0 THEN N'<EMPTY>'
                    ELSE @INVMN_existing_description
                END;
