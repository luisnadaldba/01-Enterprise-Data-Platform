    ...
    (
        ...
        WHERE ep.class = 1
        AND ep.major_id = OBJECT_ID(N'inventory.InventoryMovementReason')
        AND ep.minor_id = 0
    ...
    BEGIN
        ...
        IF @INVMR_existing_description = @INVMR_expected_description
        BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            PRINT N'            Actual                       : '
                + CASE
                    WHEN @INVMR_existing_description IS NULL THEN N'<NULL>'
                    WHEN LEN(@INVMR_existing_description) = 0 THEN N'<EMPTY>'
                    ELSE @INVMR_existing_description
                END;
