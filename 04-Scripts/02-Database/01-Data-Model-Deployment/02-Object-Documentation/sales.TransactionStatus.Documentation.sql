...
BEGIN
    ...
    IF @TRNST_existing_description = @TRNST_expected_description
    BEGIN
...
BEGIN
    ...
    BEGIN
        ...
        PRINT N'            Actual                       : '
            + CASE
                WHEN @TRNST_existing_description IS NULL THEN N'<NULL>'
                WHEN LEN(@TRNST_existing_description) = 0 THEN N'<EMPTY>'
                ELSE @TRNST_existing_description
              END;
