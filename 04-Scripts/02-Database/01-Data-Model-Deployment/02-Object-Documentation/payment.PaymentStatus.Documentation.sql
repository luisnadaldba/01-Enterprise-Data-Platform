    ...
    (
        ...
        WHERE ep.class = 1
        AND ep.major_id = OBJECT_ID(N'payment.PaymentStatus')
        AND ep.minor_id = 0
    ...
    BEGIN
        ...
        IF @PAYST_existing_description = @PAYST_expected_description
        BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            PRINT N'            Actual                       : '
                + CASE
                    WHEN @PAYST_existing_description IS NULL THEN N'<NULL>'
                    WHEN LEN(@PAYST_existing_description) = 0 THEN N'<EMPTY>'
                    ELSE @PAYST_existing_description
                END;
