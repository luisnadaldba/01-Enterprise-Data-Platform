...
BEGIN
    ...
    SELECT
        @TRNST_ActualPrimaryKeyName = kc.name
    ...
    IF @TRNST_ActualPrimaryKeyName <> N'PK_TRNST'
    BEGIN
    ...
    IF COL_LENGTH(N'sales.TransactionStatus', N'TRNST_code') IS NULL
    BEGIN
    ...
    IF COL_LENGTH(N'sales.TransactionStatus', N'TRNST_name') IS NULL
    BEGIN
    ...
    IF COL_LENGTH(N'sales.TransactionStatus', N'TRNST_is_active') IS NULL
    BEGIN
    ...
    IF COL_LENGTH(N'sales.TransactionStatus', N'TRNST_created_at') IS NULL
    BEGIN
    ...
    IF COL_LENGTH(N'sales.TransactionStatus', N'TRNST_updated_at') IS NULL
    BEGIN
