    ...
    DECLARE @PFX_uq_actual_data_space           sysname;
    ...
    DECLARE @PFX_uq_equivalent_data_space       sysname;
    ...
    DECLARE @PFX_uq_unique_index_data_space     sysname;
    ...
    BEGIN
        ...
        SET @PFX_uq_actual_data_space          = NULL;
        ...
        BEGIN
            ...
            AND @PFX_uq_actual_data_space = N'FG_CORE'
            BEGIN
        ...
        BEGIN
            ...
            BEGIN
                ...
                SELECT TOP (1)
                    ...
                    @PFX_uq_unique_index_data_space =
                        idx.DataSpaceName
